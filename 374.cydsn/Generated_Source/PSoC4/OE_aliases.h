...
#define OE_0_PS		(OE__0__PS)
#define OE_0_PC		(OE__0__PC)
#define OE_0_DR		(OE__0__DR)
#define OE_0_SHIFT	(OE__0__SHIFT)
#define OE_0_INTR	((uint16)((uint16)0x0003u << (OE__0__SHIFT*2u)))
